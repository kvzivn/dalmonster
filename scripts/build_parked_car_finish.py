...
tube('Windshield black perimeter seal',[(-.766,-.887,1.010),(.766,-.887,1.010),(.615,-.487,1.441),(-.615,-.487,1.441),(-.766,-.887,1.010)],.012,rubber,6)
...
for side in [-1,1]:tube('Parked front windshield wiper',[(side*.45,-.862,1.071),(side*.21,-.765,1.181),(side*.01,-.771,1.177)],.008,rubber,5)
...
bpy.ops.export_scene.gltf(filepath=os.path.join(ROOT,'public/assets/parked-car-finish.glb'),export_format='GLB',use_selection=True,export_yup=True,export_apply=True,export_animations=False)
bpy.ops.wm.save_as_mainfile(filepath=os.path.join(ROOT,'.dream-loop/parked-car-finish.blend'))
